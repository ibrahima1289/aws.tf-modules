# This module (aws_ecr) is not yet implemented.
...
resource "terraform_data" "not_implemented" {
  lifecycle {
    precondition {
      ...
      error_message = "The aws_ecr module is not yet implemented. Remove this module call until implementation is complete."
    }
  }
}
