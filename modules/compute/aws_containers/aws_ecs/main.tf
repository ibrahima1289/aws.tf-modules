# This module (aws_ecs) is not yet implemented.
...
resource "terraform_data" "not_implemented" {
  lifecycle {
    precondition {
      ...
      error_message = "The aws_ecs module is not yet implemented. Remove this module call until implementation is complete."
    }
  }
}
