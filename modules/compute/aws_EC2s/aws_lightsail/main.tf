# This module (aws_lightsail) is not yet implemented.
...
resource "terraform_data" "not_implemented" {
  lifecycle {
    precondition {
      ...
      error_message = "The aws_lightsail module is not yet implemented. Remove this module call until implementation is complete."
    }
  }
}
